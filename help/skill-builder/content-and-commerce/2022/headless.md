---
title: Adobe Experience Managerでヘッドレスエクスペリエンスを提供
description: 機能強化された最新の Experience Manager コンテンツフラグメントおよびヘッドレスコンテンツ配信のための新しい GraphQL API を使用したヘッドレスエクスペリエンス管理について説明します。
...
# Adobe Experience Managerでヘッドレスエクスペリエンスを提供
