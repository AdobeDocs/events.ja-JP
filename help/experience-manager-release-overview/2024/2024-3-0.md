...
# AEM as a Cloud Service 2024.3.0 リリースの更新
...
* このリリースでは、オーサリングとエッジ配信サービスが組み合わされているので、コンテンツの柔軟性とパフォーマンスのメリットを享受できます。
...
* エッジ配信サービスは AEM フォームでも使用でき、Microsoft Excel などのツールを使用してフォームをすばやく作成およびデプロイできます。
...
さらに、コンテンツフラグメントとモデルの API サポートの拡張など、開発者向けの機能強化が行われ、コンテンツフラグメントの管理と統合の自動化が容易になりました。 また、Cloud Manager には、専用の入力 IP アドレス、フレキシブルポートエグレス設定、VPN 設定を行える、高度なネットワークのセルフサービス設定オプションもあります。
