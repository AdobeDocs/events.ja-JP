...
MarketoとMochasの録音へようこそ。 これらの資料とAdobe Marketo [&#x200B; ドキュメント &#x200B;](https://experienceleague.adobe.com/docs/marketo-engage.html?lang=ja)および[&#x200B; チュートリアル &#x200B;](https://experienceleague.adobe.com/docs/marketo-learn/tutorials/overview.html?lang=ja)を組み合わせることで、Adobe Marketoを使用してビジネスをサポートする方法をより深く理解できます。
