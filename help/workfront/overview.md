            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="releases/25-7-release-webinar.md" title="Adobe Workfront 25.7 リリースウェビナー" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3464843/?format=jpeg&nocache=1765315875998" alt="Adobe Workfront 25.7 リリースウェビナー"
...
<div class="columns">
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="workshop-rewind/planning/team-success-workfront-planning.md" title="迅速な立ち上げ、スケーラブルでスマートに – Workfront Planning でチームレベルの成功を実現" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3469964/?format=jpeg&nocache=1765315876609" alt="迅速な立ち上げ、スケーラブルでスマートに – Workfront Planning でチームレベルの成功を実現"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="The Workfront Fusion Fix - Ericsson's Smarter Way to Unlocking True Event Costs">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="workshop-rewind/fusion/event-costs.md" title="Workfront Fusion の修正 – Ericsson が提供する、真のイベントコストを解放するスマートな方法" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3469977/?format=jpeg&nocache=1765315876620" alt="Workfront Fusion の修正 – Ericsson が提供する、真のイベントコストを解放するスマートな方法"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="workshop-rewind/fusion/event-costs.md" target="_blank" rel="referrer" title="Workfront Fusion の修正 – Ericsson が提供する、真のイベントコストを解放するスマートな方法">Workfront Fusion の修正 – Ericsson が提供する、真のイベントコストを解放するスマートな方法 </a>
                    </p>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Reimagining Creative Briefs in Workfront">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="workshop-rewind/workflow/creative-briefs.md" title="WorkfrontでのCreative概要の再考" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3477114/?format=jpeg&nocache=1765315876590" alt="WorkfrontでのCreative概要の再考"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="workshop-rewind/workflow/creative-briefs.md" target="_blank" rel="referrer" title="WorkfrontでのCreative概要の再考">WorkfrontでのCreative概要の再考 </a>
                    </p>
                    <p class="is-size-6">Workfrontを使用してクリエイティブブリーフを変換し、プロセスを合理化して効率を高めた方法を紹介します。</p>
                </div>
...
Adobe Workfrontの専門知識を強化するために、迅速で実用的なインサイトをお探しですか？ これらのクイックテイクは、すばやくレベルアップできるように設計された 2 つの強力なシリーズを提供します。 上位 3 つのビデオでは、実際のユーザーやエキスパートが共有する 3 つのヒント、機能、クリエイティブアプローチなど、短い短いハイライトを提供するので、すぐに適用できる実用的なアイデアを得ることができます。

対！ ビデオでは、並べて表示されるWorkfrontの機能を、見た目は似ていても目的は異なる別の機能に分類して、アプローチを取っています。 各エピソードでは、2 つのオブジェクトを比較し、それぞれの独自の強みを明確にし、それぞれをいつ使用するかを理解するのに役立ちます。

Workfrontの管理者でも、プロジェクトマネージャーでも、日常的なユーザーでも、このセクションでは、よりスマートな意思決定を行い、設定を最適化し、Workfrontをすばやく活用するのに役立つ明確で簡潔なガイダンスを提供します。
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Top 3 – Creative Approaches with Blueprints">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="quick-takes/top3/blueprints.md" title="トップ 3 - ブループリントを使ったCreativeのアプローチ" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3465311/?captions=jpn&format=jpeg&nocache=1765315877555" alt="トップ 3 - ブループリントを使ったCreativeのアプローチ"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="quick-takes/top3/blueprints.md" target="_blank" rel="referrer" title="トップ 3 - ブループリントを使ったCreativeのアプローチ"> トップ 3 - ブループリントを使用したCreativeのアプローチ </a>
                    </p>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Versus! – Groups vs. Teams">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="quick-takes/versus/groups-vs-teams.md" title="対！ - グループとチーム" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3467354/?captions=jpn&format=jpeg&nocache=1765315877551" alt="対！ - グループとチーム"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="quick-takes/versus/groups-vs-teams.md" target="_blank" rel="referrer" title="対！ - グループとチーム"> 対 - グループとチーム </a>
                    </p>
...
Workfront エキスパートインサイトシリーズは、経験豊富なWorkfront実務担当者による実践的な戦略と高度なヒントを解き放つ頼れるリソースです。 各ビデオでは、ガバナンスキューとリクエストキューからSLA レポート、Fusion のユースケース、コンテンツ supply chain ワークフローなど、新しいテーマに掘り下げます。
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="expert-insights/adoption.md" title="Expert Insights - Leslie Spier による導入" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3469928/?captions=jpn&format=jpeg&nocache=1765315878072" alt="Expert Insights - Leslie Spier による導入"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="expert-insights/adoption-surveys.md" title="Expert Insights - Jaime Davidson による導入調査" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3469895/?format=jpeg&nocache=1765315878064" alt="Expert Insights - Jaime Davidson による導入調査"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            ...
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="expert-insights/agile.md" title="エキスパートインサイト - Natalie Mitchell によるアジャイル" target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3469917/?captions=jpn&format=jpeg&nocache=1765315878067" alt="エキスパートインサイト - Natalie Mitchell によるアジャイル"
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
