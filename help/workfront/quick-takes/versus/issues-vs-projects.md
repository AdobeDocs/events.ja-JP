---
title: VS. - イシューとプロジェクト
description: Adobe Workfrontの課題とプロジェクトの違いを確認し、チームのワークフローとレポートのニーズに適したアプローチを見つけましょう。
...
「オンデマンドWorkfront CSM」が復活しました。 この対で！ 課題に取り組むことと、作業を管理するためのプロジェクトに取り組むことです。

>[!VIDEO](https://video.tv.adobe.com/v/3484991/?learn=on&enablevpops)

イシュー、カスタム Forms、プロジェクトテンプレートを使用した作業の管理について詳しくは、 その他のリソース：
