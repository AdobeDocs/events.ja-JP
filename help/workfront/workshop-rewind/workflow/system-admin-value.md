---
title: Workfront システム管理者としての影響の所有
description: Workfrontのシステム管理者が、どのようにテクノロジーに関する作業を目に見える価値に変換し、経営陣とビジネスの成長に貢献できるのかを解説します。
...
# Workfront システム管理者としての影響の所有

TD BankのEnterprise Workfront Platform Lead &amp; Product OwnerであるNuria Munguia氏が、Workfrontのシンプルかつ戦略的な設定によって、チームの影響やビジネス価値を詳細に可視化する方法を解説します。
