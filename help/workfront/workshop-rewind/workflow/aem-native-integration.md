---
title: WorkfrontとAEMのネイティブ統合の活用
description: このイベントでは、統合の概要、準備方法（マッピングプロセス、メタデータの調整、適切な権限の確保など）に関するインサイト、設定のウォークスルーのデモを行います。
topic: Integrations
...
# WorkfrontとAEMのネイティブ統合の活用

Myka Bohnsack と Warren Barton が、Workfront + AEM Native Integration イベントの専門知識を紹介します。
