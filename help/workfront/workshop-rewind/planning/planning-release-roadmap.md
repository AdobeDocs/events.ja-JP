---
title: ビジョンから価値へ – Workfront計画リリースとロードマップ
description: ワークショップ巻き戻し – 計画
...
# ビジョンから価値へ：Workfront計画リリースとロードマップ

Adobe Workfrontのプロダクトマネジメント部門では、Workfront計画の最新の改善点や次のステップをご紹介しています。

戦略と作業の連携、チームの連携、計画を自信をもって容易に行えるように、新機能がどのように設計されているのかをご確認ください。
...
- [Workfront Planning APIの概要](https://developer.adobe.com/wf-planning/api/v1/)
- [Workfront Workflow API Explorer](https://developer.adobe.com/workfront/api-explorer/)
- イベントで共有したいアイデアやフォローアップの質問はありますか？ 毎月新しいイベントが追加される[Experience League コミュニティ投稿](https://experienceleaguecommunities.adobe.com/t5/workfront-discussions/event-follow-up-from-vision-to-value-workfront-planning-release/td-p/785666!?profile.language=ja)のコメントに、お気軽に投稿してください。最新のセッションについては、Experience League イベント ページをご覧ください。
