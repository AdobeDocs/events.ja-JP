---
title: Adobe Workfront 2025 年第 4 四半期リリースウェビナー
description: このウェビナーでは、新しいリクエストエクスペリエンス、AI レビュアー、ワークロードバランサーのアップデート、Planning and Fusion の機能など、新しい機能強化について重点的に説明しました
...
# Adobe Workfront 2025 年第 4 四半期リリースウェビナー

Workfrontの第 4 四半期リリースは 2025 年 10 月 16 日（PT）にデプロイされました。   このウェビナーは、Adobe Product Management チームと協力してホストされ、新しいリクエスト経験、AI レビュアー、ワークロードバランサーのアップデート、Planning and Fusion の機能など、新しい機能強化を重点的に説明しました。

>[!VIDEO](https://video.tv.adobe.com/v/3477133/?learn=on&enablevpops)

ライブセッションに参加できなければ、心配はいりません。 [ スライドデッキ ](https://workfront-experience.s3.us-west-2.amazonaws.com/Training/Guides/Customer+Success+at+Scale/100925+-+Fourth+Quarter+Release+Webinar.pdf) を確認し、オンデマンド録画が続くのを見ます。
