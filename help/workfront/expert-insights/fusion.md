...
description: Ewan Hruska氏からFusionのベストプラクティスを学びましょう。 Adobe Workfront Fusionを利用して、ワークフローを文書化、最適化、拡張し、効率性を向上する方法をご確認ください。
...
Expert Insightsへようこそ！  あなたの「オンデマンド」WorkfrontCSMのシンシア・ブーンです。このエピソードでは、Ewan Hruskaが参加します。 彼は本当に魔法のような「Fusionの騎士」であり、ツールを最大限に活用するための専門家のアドバイスに沿ってFusionの利点を共有しています。
...
Ewanは、毎年100社に上るAdobe Workfrontのお客様と連携して活動するシニアカスタマーサクセスアーキテクトです。  ITおよびマーテクチームとソフトウェア慣行を主導した20年の経験から、コンサルテーションアプローチを推進するための豊富な知識を得ています。  アウトドアや友人と音楽を楽しむことを好むだけでなく、手順を大規模に改善することに情熱を注ぎ、Adobe Workfront Fusion テンプレートを作成しています。
