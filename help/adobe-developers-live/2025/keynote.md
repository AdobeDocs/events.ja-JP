---
title: Agentic Web Keynote の構築
description: AEM Agents などを取り上げた、Adobeの Agentic Web に対するビジョンを使用して、デジタルエクスペリエンスにおける AI の役割を探ります。
role: Developer
...
# 基調講演：Agentic Web の構築

Adobe Developers Live 2025 の基調講演では、AI がどのようにデジタルエクスペリエンスを変えるかを紹介します。 AEM Agents、コンテンツ AI 基盤サービス、Brand Conciergeなどに関するインサイトを活用した、Adobeの Agentic Web 向けビジョンについて説明します。 このイベントでは、専門家が集まり、世界中の開発者や建築家のための革新的なソリューションについて話し合います。
