...
+ [概要](overview.md)
+ エピソード {#episodes}
   + [EP. 55：職場のエージェント：オーディエンスとジャーニーの作成およびアクティブ化](episodes/exl-live-episode-01-28-26.md)
   + [EP. 54：製品サポートエージェントによるトラブルシューティングとサポートケース管理の簡素化](episodes/exl-live-episode-12-16-25.md)
   + [EP. 53：実験の次の時代：Agentic AI がどのようにして、よりスマートなテストと成長を促進したか](episodes/exl-live-episode-10-30-25.md)
   + [EP. 52:Adobe Experience Platform Agent Orchestrator](episodes/exl-live-episode-10-22-25.md)
   + [EP. 51:Customer Journey Analytics B2B editionの力を解き放つ](episodes/exl-live-episode-10-16-25.md)
   + [EP. 50:Journey Optimizerの RCS と WhatsApp でモバイルリーチを拡大](episodes/exl-live-episode-09-30-25.md)
   + [EP. 49:AEM コンテンツフラグメントと Dynamic Media を使用したJourney Optimizerのパーソナライズされたコンテンツの促進](episodes/exl-live-episode-07-31-25.md)
   + [Ep. 48:マスターのフリークエンシーキャップと競合の優先順位](episodes/exl-live-episode-06-18-25.md)
   + [Ep. 47：大規模なパーソナライズされたコンテンツに対するアジャイルワークフロー](episodes/exl-live-episode-47-2025-06-05.md)
   + [Ep. 46:Content Analytics:AI インサイトによるパフォーマンスの最適化](episodes/exl-live-episode-05-22-25.md)
   ...
   + [Ep. 27:Adobe Journey Optimizerでの API トリガーメッセージ](episodes/exl-live-episode-8-23-23.md)
   + [Ep. 26：標準的なコントロールを使用し、任意のソースから&#x200B;アクションにつながるオーディエンスを 1 か所に集約する](episodes/exl-live-episode-7-20-23.md)
   + [Ep. 25:web チャネルとコンテンツ実験でAdobe Journey Optimizerの未来を探る](episodes/exl-live-episode-6-14-23.md)
   + [Ep. 24: Adobe Journey Optimizerでモバイルアプリの可能性を最大化](episodes/exl-live-episode-5-24-23.md)
   + [Ep. 23：数回のクリックでデータ収集とイベントの転送を開始および実行する方法を学ぶ](episodes/exl-live-episode-4-25-23.md)
   + [Ep. 22:web エクスペリエンスの高速化](episodes/exl-live-episode-2-16-23.md)
   + [Ep. 21：データ収集のハイライトとロードマップ](episodes/exl-live-episode-1-26-23.md)
   + [Ep. 20: [!DNL Analytics]  オフィスまたは外出先](episodes/exl-live-episode-11-18-22.md)
