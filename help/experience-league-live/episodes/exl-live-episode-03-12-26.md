...
description: Journey Optimizerでの Campaign Orchestration が、オーディエンスの作成からローンチに至るまで、大規模な 1 対多のマルチチャネルマーケティングプログラムをどのように管理するかをご覧ください。
kt: KT-19994
...
Journey Optimizerでの Campaign Orchestration が、オーディエンスの作成からローンチに至るまで、大規模な 1 対多のマルチチャネルマーケティングプログラムをどのように管理するかをご覧ください。
...
[&#x200B; リマインダーを設定 &#x200B;](https://www.youtube.com/live/mPVvZIbkJq8){target="_blank"}
