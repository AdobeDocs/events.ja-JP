...
description: 新しい web チャネルを使用すると、マーケターはWYSIWYG ビジュアルデザイナーで web キャンペーンを作成できます。 さらに、Journey Optimizerでは、メール、web、プッシュ、アプリ内、SMS など、任意のチャネルでコンテンツを実験できるようになりました。
...
新しい web チャネルを使用すると、マーケターはWYSIWYG ビジュアルデザイナーで web キャンペーンを作成できます。 さらに、Journey Optimizerでは、メール、web、プッシュ、アプリ内、SMS など、任意のチャネルでコンテンツを実験できるようになりました。
