...
description: Adobe Experience Cloudのデータ収集に関する 3 つのセッションのうちのこの 2 番目のライブストリーミングセッションでは、お気に入りのエキスパートが、Adobe RTCDP Connections 製品を詳細に紹介します。お客様は、サーバーサイドタグ管理システムを使用してAdobe以外の宛先にイベントを転送できます。
...
Adobe Experience Cloudのデータ収集に関する 3 つのセッションのうちのこの 2 番目のライブストリーミングセッションでは、お気に入りのエキスパートが、Adobe RTCDP Connections 製品を詳細に紹介します。お客様は、サーバーサイドタグ管理システムを使用してAdobe以外の宛先にイベントを転送できます。
