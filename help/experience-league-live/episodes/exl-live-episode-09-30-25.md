---
title: Journey OptimizerのRCSとWhatsAppでモバイルリーチを拡大
description: AJOで、WhatsApp、RCS、SMSを利用して、モバイルエンゲージメントを強化する方法をご覧ください。豊かでインタラクティブな、パーソナライズされたエクスペリエンスを利用できます。
kt: KT-18688
