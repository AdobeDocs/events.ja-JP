---
title: AI Bash - Adobe Experience Platform アプリケーションおよび Campaign で AI アシスタントの威力を発揮
description: AI 駆動型ツールは、顧客エンゲージメントとワークフローの効率化に変革をもたらしています。 AIをテーマにしたExperience Leagueライブウェビナーで、イノベーションのスピードに対応し、Adobeの機能がどのように生産性を向上させるのかをご確認ください。 
kt: KT-15472
...
# AI Bash - Adobe Experience Platform アプリケーションおよび Campaign で AI アシスタントの威力を発揮

Adobe Experience CloudアプリケーションとAdobe Campaignで、AI アシスタントが顧客とのやり取りを変革し、生産性を向上させる方法をご確認ください。 

>[!VIDEO](https://video.tv.adobe.com/v/3434781/?learn=on)

**詳細を表示**:

AI 駆動型ツールは、顧客エンゲージメントとワークフローの効率化に変革をもたらしています。 AIをテーマにしたAdobe Experience Leagueのライブショーで、イノベーションのペースに対応し、Adobeの機能がどのように生産性を加速させるかをご確認ください。
...
[&#x200B; セキュリティ ファクトシート &#x200B;](https://www.adobe.com/content/dam/cc/en/trust-center/ungated/whitepapers/experience-cloud/adobe-ai-assistant-in-aep-security-fact-sheet.pdf)
