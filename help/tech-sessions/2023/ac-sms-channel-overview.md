...
description: SMS アーキテクチャ、SMS チャネルの設定、SMPP外部アカウントの設定、SMS配信の作成、およびトラブルシューティングについて説明します。
...
このセッションでは、SMS アーキテクチャ、SMS チャネルの設定、SMPP外部アカウントの設定、SMS配信の作成、およびトラブルシューティングについて説明します。
