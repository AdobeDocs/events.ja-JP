---
title: CDPのベストプラクティス：人とプロセス
description: テクノロジーの背後にある人とプロセスに投資することで、CDPを最大限に活用する方法を学びましょう。 AdobeのNina Carusoさんが、組織の設定方法について説明します（説明は60 ～ 160文字にする必要があります）。
...
# CDPのベストプラクティス：人とプロセス

テクノロジーの背後にある人とプロセスに投資することで、CDPを最大限に活用する方法を学びましょう。 AdobeのNina Caruso氏が、組織の分断を解消しながら、ビジネスを成功に導く方法を解説します。
